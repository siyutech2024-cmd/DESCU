...
export const es: TranslationTable = {
  ...
  'orders.status.paid_cash': 'Efectivo al entregar',
  ...
  'nego.buyer_offer': 'Oferta del comprador',
  'negotiate.too_low': 'La oferta mínima es {min}',
  'negotiate.subtitle_hint': 'El vendedor puede aceptar, rechazar o contraofertar. Si acepta, el nuevo precio se aplica a tu pedido.',
  'chat.pick_conversation': 'Elige una conversación',
  'chat.pick_conversation_hint': 'Tus mensajes con compradores y vendedores aparecen aquí.',
  'negotiate.not_below': 'La oferta debe ser menor al precio publicado',
  'condition.new': 'Nuevo',
  'condition.used': 'Usado',
  'product.link_copied': 'Enlace copiado',
  'product.copy_link': 'Copiar enlace',
  'credit.level.new': 'Nuevo',
  'credit.level.bronze': 'Bronce',
  'credit.level.silver': 'Plata',
  'credit.level.gold': 'Oro',
  'credit.level.diamond': 'Diamante',
  'detail.contact_short': 'Chatear',
  'product.arrange_meetup_short': 'Quedar',
  'product.want_it_short': 'Comprar',
  'footer.how_it_works': 'Cómo funciona',
  'footer.privacy': 'Privacidad',
  'payout.connected': 'Cuenta de cobro conectada',
  'product.marked_sold': 'Marcado como vendido',
