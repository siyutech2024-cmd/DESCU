...
export const en: TranslationTable = {
  ...
  'product.not_found_title': 'Listing not found',
  'product.not_found_body': 'It may have been sold, removed, or the link is wrong.',
  'product.not_found_back': 'Back to home',
  'common.loading': 'Loading…',
  'nego.buyer_offer': 'Buyer\'s offer',
  'negotiate.too_low': 'The minimum offer is {min}',
  'negotiate.subtitle_hint': 'The seller can accept, decline or counter. If they accept, the new price applies to your order.',
  'chat.pick_conversation': 'Pick a conversation',
  'chat.pick_conversation_hint': 'Your messages with buyers and sellers show up here.',
  'negotiate.not_below': 'The offer must be below the asking price',
  'condition.new': 'New',
  'condition.used': 'Used',
  'product.link_copied': 'Link copied',
  'product.copy_link': 'Copy link',
  'credit.level.new': 'New',
  'credit.level.bronze': 'Bronze',
  'credit.level.silver': 'Silver',
  'credit.level.gold': 'Gold',
  'credit.level.diamond': 'Diamond',
  'detail.contact_short': 'Chat',
  'product.arrange_meetup_short': 'Meet up',
  'product.want_it_short': 'Buy',
  'footer.how_it_works': 'How it works',
  'footer.privacy': 'Privacy',
  'payout.connected': 'Payout account connected',
  'product.marked_sold': 'Marked as sold',
