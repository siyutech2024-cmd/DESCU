...
const EXPECTED_ROUTES = [
    'GET /', 'GET /api/test_ping',
    'POST /api/analyze', 'GET /api/products', 'POST /api/products', 'GET /api/products/:id', 'GET /api/products/health',
    'POST /api/conversations', 'DELETE /api/conversations/:conversationId', 'GET /api/conversations/:conversationId/messages',
    ...
    'GET /api/orders', 'POST /api/orders/create', 'GET /api/orders/:id', 'POST /api/orders/:id/confirm', 'POST /api/orders/:id/arrange-meetup',
    'POST /api/orders/ship', 'POST /api/orders/confirm', 'GET /api/orders/health', 'POST /api/disputes',
    'POST /api/payment/webhook', 'POST /api/payment/create-intent', 'POST /api/payment/connect', 'POST /api/payment/bank-info',
    'GET /api/payment/dashboard/:userId', 'POST /api/payment/verify',
    'POST /api/stripe/add-bank-account', 'GET /api/stripe/account-status', 'POST /api/stripe/v2/create-account', 'GET /api/stripe/v2/account-status',
    'POST /api/stripe/v2/account-link', 'GET /api/stripe/v2/dashboard-link', 'POST /api/stripe/v2/checkout-session', 'POST /api/stripe/v2/webhook',
    'GET /api/stripe/seller-balance', 'POST /api/stripe/seller-payout', 'GET /api/stripe/seller-payouts',
    'POST /api/stripe/create-express-account', 'GET /api/stripe/express-status', 'POST /api/stripe/create-payment-intent', 'POST /api/stripe/confirm-payment',
...
describe('API route table', () => {
    ...
    it('serves GET /api/products/health before the :id matcher', () => {
        const routes = collectRoutes(app);
        const health = routes.findIndex(r => r.path === '/api/products/health');
        const byId = routes.findIndex(r => r.path === '/api/products/:id');
